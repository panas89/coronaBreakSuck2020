...
if __name__ == "__main__":
    ...
    filenames_bioarxiv = getListOfFiles(
        path_all_archives + path_bioarxiv, extention="json"
    )
    ...
    filenames_comm_use = getListOfFiles(
        path_all_archives + path_comm_use, extention="json"
    )
    ...
    filenames_cust_lic = getListOfFiles(
        path_all_archives + path_cust_lic, extention="json"
    )
    ...
    filenames_non_comm_use = getListOfFiles(
        path_all_archives + path_non_comm_use, extention="json"
    )
